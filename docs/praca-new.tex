...
Aby dołączyć Ash-a do swojego projektu należy wydać następujące polecenie\footnote{Jeśli nie masz jeszcze zainstalowanego Cordova CLI spójrz tutaj https://github.com/apache/cordova-cli} w~folderze z~projektem:
\begin{quote}
...
\begin{enumerate}
  \item Dodajemy Ash-a do projektu korzystając z~\textit{Cordova CLI}.\footnote{Projekt dostępny pod adresem \url{https://github.com/apache/cordova-cli}}
...
oraz załadowanie tego testu z~poziomu Ash-a po zajściu zdarzenia \texttt{deviceready}. Stosownym miejscem dla tego będzie funkcja \texttt{init()} w~assets/www/js/main.js
...
Na chwilę obecną nawet w~samym JavaScript istnieje wiele implementacji specyfikacji Promises. W Ash-u pierwotnie zastosowano bibliotekę o~nazwie promises.js dostępną pod adresem
...
\begin{center}
    ...
    12 & ,,Error'' & ,,Page element doesn't implement required method!'' & Obiekt przekazany jako Ash-a jako Page Object nie implementuje którejś z~wymaganych funkcji  \\ \hline
    \end{tabularx}
\end{center}
